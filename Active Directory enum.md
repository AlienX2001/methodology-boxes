...
2. Windows AD's also have an inbuilt DNS db called ADIDNS, in which by default any "authenticated user" can add records using ldap (provided that record doesnt already exist in it, more on that here https://www.netspi.com/blog/technical/network-penetration-testing/exploiting-adidns/)
